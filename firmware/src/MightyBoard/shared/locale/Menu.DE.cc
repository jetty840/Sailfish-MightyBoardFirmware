...
const PROGMEM prog_uchar START_TEST_MSG[]=  "Ich drucke eine     " "Serie von Linien,   " "um die Duesen       " "auszurichten.       ";
const PROGMEM prog_uchar EXPLAIN1_MSG[] =   "Finde die besten    " "uebereinstimmenden  " "Linien je Achse.    " "Linien sind von 1-13";
const PROGMEM prog_uchar EXPLAIN2_MSG[] =   "Zeile eins          " "ist extra lang.     " "Y Achse ist links   " "X Achse ist rechts. ";
const PROGMEM prog_uchar END_MSG  [] =      "   Einstellungen    " "       wurden       " "    erfolgreich     " "    gespeichert!    ";
...
const PROGMEM prog_uchar HEATER_ERROR_MSG[]=  "Duesen heizen nicht " "Pruefe die Kabel.   " "       ";

const PROGMEM prog_uchar STOP_EXIT_MSG[]   = "Beginne Laden oder  " "Entladen. Druecke'M'" "zum beenden.";
const PROGMEM prog_uchar TIMEOUT_MSG[]  	  = "5 Minuten timeout   " "wurden erreicht 'M' " "zum beenden.";
...
const PROGMEM prog_uchar CARDCOMMS_MSG[]   = "SD-Karte fehlerhaft." "Verwende eine andere" "SD-Karte.       ";
...
const PROGMEM prog_uchar CARDCRC_MSG[]     = "SD-Karte Lesefehler." "Zu viele CRC fehler." "Schlechter Kontakt, " "oder Defekt.";
const PROGMEM prog_uchar CARDFORMAT_MSG[]  = "Kartenformat nicht  " "lesbar. Formatiere  " "mit FAT-16.";
const PROGMEM prog_uchar CARDSIZE_MSG[]    = "SD-Karte nicht      " "lesbar, Partition   " "ueber 2GB. Mit      " "FAT-16 Formatieren.";
const PROGMEM prog_uchar EXTRUDER_TIMEOUT_MSG[] = "Timeout beim heizen " "der Duese.";
const PROGMEM prog_uchar PLATFORM_TIMEOUT_MSG[] = "Timeout beim heizen " "der Plattform.";
...
const PROGMEM prog_uchar NOZZLE_ERROR_MSG[] = "Toolhead Offset Sys " "must be set to NEW  " "to use this utility.";
...
const PROGMEM prog_uchar PROFILES_MSG[]	  = "Profile";
...
const PROGMEM prog_uchar LINE_NUMBER_MSG[] = "Zeile:              ";
...
const PROGMEM prog_uchar ERROR_STREAM_VERSION[] = "This is not the x3g version I work best with. "
	"For help see: makerbot.com/help   ";

#ifdef MODEL_REPLICATOR2
const PROGMEM prog_uchar ERROR_BOT_TYPE[] =
...
const PROGMEM prog_uchar ALT_UART_MSG[] = "Alternativ UART";
#endif
