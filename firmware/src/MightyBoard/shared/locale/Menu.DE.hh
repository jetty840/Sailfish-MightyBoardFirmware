...
const static PROGMEM prog_uchar NO_MSG[]   =       "NO ";  /* max 3 must be NEIN */
const static PROGMEM prog_uchar YES_MSG[]  =       "JA ";  /* max 3 */
...
const static PROGMEM prog_uchar VERSION_MSG[] = 	 "Versions Info      ";
const static PROGMEM prog_uchar DSTEPS_MSG[] =           "Steppers ausschalt.";
const static PROGMEM prog_uchar ESTEPS_MSG[] =           "Steppers einschalt.";
const static PROGMEM prog_uchar PLATE_LEVEL_MSG[] =      "Plattform heben";
const static PROGMEM prog_uchar PREHEAT_SET_MSG[] =      "Vorheiz Einstellung";
const static PROGMEM prog_uchar SETTINGS_MSG[] =         "Generelle Einst.   ";
const static PROGMEM prog_uchar RESET_MSG[] =            "Einstellungen RESET";
...
const static PROGMEM prog_uchar OVERRIDE_GCODE_TEMP_MSG[] = "Override GcTemp "; /* max lenght 16 */
const static PROGMEM prog_uchar PAUSE_HEAT_MSG[]	  = "Pause mit Heiz. ";
