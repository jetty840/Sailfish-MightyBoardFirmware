...
#define LCD_D0_PIN		Pin(PortD,6)
#define LCD_D1_PIN		Pin(PortD,7)
#define LCD_D2_PIN		Pin(PortE,6)
#define LCD_D3_PIN		Pin(PortE,7)
...
// these pins are unconnect, they are place holders until we can adjust the code 
#define INTERFACE_X+_PIN        Pin(PortJ,7)
#define INTERFACE_X-_PIN        Pin(PortH,7)
#define INTERFACE_Y+_PIN        Pin(PortA,0)
#define INTERFACE_Y-_PIN        Pin(PortA,1)
#define INTERFACE_Z+_PIN        Pin(PortE,7)
#define INTERFACE_Z-_PIN        Pin(PortE,6)
